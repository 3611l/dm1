...
#define OFFSET_ORIGIN                       0x014c //m_vecAbsOrigin-[DataMap.CBaseViewModel]
...
#define OFFSET_AMMO                 0x1644 //m_ammoInClip-[RecvTable.DT_PropSurvival]
...
#define OFFSET_IN_FORWARD           0x076781a0 //player is in forward, in_forward
